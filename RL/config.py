...
data_arg.add_argument('--lambda_flag_default', action="store_true",default=True,
...
train_arg.add_argument('--gpu', type=int, default=0, help='gpu')
train_arg.add_argument('--nb_epoch', type=int, default=5000, help='nb epoch')
